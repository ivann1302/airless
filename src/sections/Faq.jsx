...
const faqItems = [
  ...
  {
    question: 'Опасен ли пыльный туман при работе с безвоздушной покраской?',
    answer:
      'Нет. технология  безвоздушной покраски минимизирует разбрызгивание и грязный туман, поэтому поверхность остаётся чистой, а расход материалов контролируется.',
  },
];
